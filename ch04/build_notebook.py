# -*- coding: utf-8 -*-
r"""ch04_data_collection.ipynb 생성기"""
import io, sys
...
cells.append(new_markdown_cell(
    "# Chapter 3 §4.2~§4.4 실습 — 데이터 수집과 스키마 매핑\n"
    "\n"
...
cells.append(new_markdown_cell(
    ...
    "\n"
    "Ch.3에서 pandas는 이미 깔았다. 본 챕터에서 새로 쓰는 라이브러리는 세 가지다.\n"
    "\n"
...
with open("ch04_data_collection.ipynb", "w", encoding="utf-8") as f:
    nbf.write(nb, f)

print(f"[OK] ch04_data_collection.ipynb ({len(cells)} cells)")
