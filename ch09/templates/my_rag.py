...
if __name__ == "__main__":
    # =========================================================================
    # 자관 자료에 맞춘 시험 질의. 아래는 '학칙·규정' 예시이니 자관 질의로 바꿔 쓴다.
    #   1~4번: 답이 자료에 분명히 있는 검증 가능 질의
    #   5번  : 자료에 '일부러 없는' 주제 → 환각 방어 시험 (책 §8.5)
    # '...'로 남겨 둔 자리는 자동으로 건너뛴다.
    # =========================================================================
    TEST_QUERIES = [
        '군대를 제대했는데 복학하려면 어떻게 해야 하나요?',
        '임신이나 출산을 이유로 휴학할 수 있나요?',
        '휴학은 최대 몇 학기까지 가능한가요?',
        '복학 신청은 언제까지 해야 하나요?',
        '학교 기숙사 식당 메뉴가 궁금해요.',   # 5) 자료에 없는 주제 — 환각 방어 시험
    ]

    for q in TEST_QUERIES:
        if q == '...':
            continue                 # '...'로 비워 둔 자리는 건너뜀
