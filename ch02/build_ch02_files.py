# -*- coding: utf-8 -*-
r"""
ch02_schema.csv 와 ch02_sample.jsonl 생성기

교재 Chapter 2 §2.4의 코드를 그대로 따른다.
...
print(f"[OK] ch02_schema.csv ({len(schema)} fields)")
...
print(f"[OK] ch02_sample.jsonl ({len(sample)} records)")
